...
one_tile <- get_map(location = c(lon = 116.4164, lat = 39.92835), zoom = 16, maptype = "satellite") 
...
bb <- bounding_box(39.92835, 116.4164, 0.62, in.miles=TRUE )
...
points_frame <- data.frame(lon = c(xmax, 116.4164, xmin),
                           lat = c(ymax, 39.92835, ymin),
...
ggmap(one_tile, 
      ...
      # geom_point(data=data.frame(lon = 116.4164, lat = 39.92835), size=7, color="yellow")
```
