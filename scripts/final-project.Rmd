...
chips_rur_1988_filt <- chips_rur_1988_filt %>% left_join(prov_county_main, by=c('UCODE'='code')) %>% na.omit()
...
a <- chips_rur_1988_filt %>% filter(lat != 0)
```
...
#mapview(data.frame(x = prov_county_main$long, y = prov_county_main$lat), xcol = "x", ycol = "y", crs = 4326, na.rm=TRUE)
mapviewOptions(basemaps = c("CartoDB.DarkMatter", "OpenStreetMap.DE"),
               layers.control.pos = "topright")
mapview(data.frame(x = a$long  , y = a$lat), xcol = "x", ycol = "y", crs = 3857)
